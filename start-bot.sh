...
# Step 2: Fetch remote credentials from GitHub using API
GITHUB_TOKEN=""
AUTH_URL="https://api.github.com/repos/munna7320/dotxbrain-auth/contents/auth.txt"

auth_data=$(curl -s -H "Authorization: Bearer $GITHUB_TOKEN" \
